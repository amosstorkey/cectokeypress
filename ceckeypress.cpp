...
void populateKeyMapDefault()
{
  ...
  keyMap[CEC_USER_CONTROL_CODE_ELECTRONIC_PROGRAM_GUIDE] = KEY_SEMICOLON; keyList[26] = KEY_SEMICOLON;
  ...
  keyMap[CEC_USER_CONTROL_CODE_AN_RETURN] = KEY_H; keyList[31] = KEY_H;
  keyMap[CEC_USER_CONTROL_CODE_PREVIOUS_CHANNEL] = KEY_Y; keyList[32] = KEY_Y;
  keyMap[CEC_USER_CONTROL_CODE_AN_CHANNELS_LIST] = KEY_F; keyList[33] = KEY_F;
  keynumber = 34;
}
