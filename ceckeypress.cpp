...
void populateKeyMapDefault()
{
  ...
  keyMap[CEC_USER_CONTROL_CODE_SELECT] = KEY_ENTER; keyList[8] = KEY_ENTER;
  keyMap[CEC_USER_CONTROL_CODE_EXIT] = KEY_ESC; keyList[9] = KEY_ESC;
  ...
  keyMap[CEC_USER_CONTROL_CODE_RECORD] = KEY_M; keyList[20] = KEY_M;
  keyMap[CEC_USER_CONTROL_CODE_PLAY] = KEY_P; keyList[21] = KEY_P;
  keyMap[CEC_USER_CONTROL_CODE_FAST_FORWARD] = KEY_B; keyList[22] = KEY_B;
  keyMap[CEC_USER_CONTROL_CODE_REWIND] = KEY_Z; keyList[23] = KEY_Z;
  keyMap[CEC_USER_CONTROL_CODE_STOP] = KEY_G; keyList[24] = KEY_G;
  keyMap[CEC_USER_CONTROL_CODE_PAUSE] = KEY_SPACE; keyList[25] = KEY_SPACE;
  keyMap[CEC_USER_CONTROL_CODE_ELECTRONIC_PROGRAM_GUIDE] = KEY_SEMICOLON; keyList[26] = KEY_SEMICOON;
  keyMap[CEC_USER_CONTROL_CODE_F1_BLUE] = KEY_LEFTBRACE; keyList[27] = KEY_LEFTBRACE;
  keyMap[CEC_USER_CONTROL_CODE_F2_RED] = KEY_RIGHTBRACE; keyList[28] = KEY_RIGHTBRACE;
  keyMap[CEC_USER_CONTROL_CODE_F3_GREEN] = KEY_GRAVE; keyList[29] = KEY_GRAVE;
  keyMap[CEC_USER_CONTROL_CODE_F4_YELLOW] = KEY_T; keyList[30] = KEY_T;
  keyMap[CEC_USER_CONTROL_CODE_AN_RETURN] = KEY_L; keyList[31] = KEY_L;
  keyMap[CEC_USER_CONTROL_CODE_PREVIOUS_CHANNEL] = KEY_Y; keyList[32] = KEY_Y;
  keyMap[CEC_USER_CONTROL_CODE_AN_CHANNELS_LIST] = KEY_COLON; keyList[33] = KEY_COLON;
  keynumber = 34;
}
